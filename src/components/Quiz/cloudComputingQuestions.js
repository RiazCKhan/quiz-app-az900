const cloudConceptQuestions = [
  ...
  },
  {
    ...
    difficulty: "medium",
    question:
      "WWhich of the following is a cloud based service provided by Azure?",
  ...
  },
  {
    ...
    type: "multiple",
    difficulty: "medium",
    question: "Select the cloud based service(s) provided by Azure?",
    correct_answer: "Centralized account management",
    incorrect_answers: ["Local storage", "Database extraction", "Nord VPN"],
    options: [
      "Local storage",
      "Database extraction",
  ...
  },
  {
    ...
    type: "multiple",
    difficulty: "medium",
    question: "What is an example of a computing service??",
  ...
  },
  {
    ...
    difficulty: "medium",
    question:
      "Select the most accurate answer representing 'popular' computing service?",
  ...
  },
  {
    ...
    incorrect_answers: [
      "A public cloud is built, and controlled, by Steve",
      "A public cloud is only built to host backup data",
  ...
  },
  {
    ...
    incorrect_answers: [
      ...
      "Is always 50/50 public to private cloud ratio",
  ...
  },
  {
    ...
    difficulty: "medium",
    question:
      "In the IaaS model, the cloud provider is responsible for the operating system installation, configuration, and maintenance; network config database and storage config, etc.",
    correct_answer: "False",
    incorrect_answers: ["True"],
    options: ["True", "False"],
  },
